...
T = TypeVar("T", bound="CreateUserChatRequest")


@_attrs_define
class CreateUserChatRequest:
    """
    Attributes:
        thread_id (str):
        token (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_user_chat_request = cls(
            thread_id=thread_id,
            token=token,
            prompt_table_ids=prompt_table_ids,
        )

        create_user_chat_request.additional_properties = d
        return create_user_chat_request
