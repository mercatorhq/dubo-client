...
if TYPE_CHECKING:
    from ..models.create_postgres_data_source_extras import CreatePostgresDataSourceExtras
    from ..models.postgres_ssl_info import PostgresSSLInfo


T = TypeVar("T", bound="CreatePostgresDataSource")


@_attrs_define
class CreatePostgresDataSource:
    ...
    Attributes:
        ...
        port (int):
        database (str):
        extras (Union[Unset, CreatePostgresDataSourceExtras]):
    ...
    port: int
    database: str
    extras: Union[Unset, "CreatePostgresDataSourceExtras"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_extras, Unset):
            ...
            extras = CreatePostgresDataSourceExtras.from_dict(_extras)
        ...
        create_postgres_data_source = cls(
            name=name,
            username=username,
            host=host,
            port=port,
        ...
        create_postgres_data_source.additional_properties = d
        return create_postgres_data_source
