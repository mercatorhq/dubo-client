...
def sync_detailed(
    *,
    ...
    Args:
        query (Union[Unset, str]): The question to answer
        user_query (Union[Unset, str]): The question to answer
        schemas (Union[Unset, List[str]]): The table schema(s) to use
        descriptions (Union[Unset, List[str]]): The table description(s) to use
        data_header (Union[Unset, List[str]]): The data header to use
        macros (Union[Unset, bool]): Enable or disable macros
        fast (Union[Unset, bool]): Use faster less accurate model
        model (Union[Unset, str]): Model to use
        json_body (BodyReadQueryV1DuboQueryGet):
