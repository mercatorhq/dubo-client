...
def _get_kwargs(
    *,
    ...
    shingle_length: Union[Unset, None, int] = 1000,
    step: Union[Unset, None, int] = 500,
    x_dubo_key: str,
) -> Dict[str, Any]:
    headers = {}
...
def sync_detailed(
    *,
    ...
    Args:
        data_source_documentation_id (str):
        shingle_length (Union[Unset, None, int]):  Default: 1000.
        step (Union[Unset, None, int]):  Default: 500.
        x_dubo_key (str):
        multipart_data (BodyUpdateDocumentApiV1DuboDocumentationPut):
